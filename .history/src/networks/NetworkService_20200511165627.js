...
class NetworkService {
  ...
  fetchAlbums(data){
    ...
    console.log('URLLLLLL', url);
    data.pruebaAlbums.user = data.user.correo 
    console.log("data.pruebaAlbums.user ", data.pruebaAlbums.user)
    return RequestService.postRequest(url,data.pruebaAlbums);
  }
