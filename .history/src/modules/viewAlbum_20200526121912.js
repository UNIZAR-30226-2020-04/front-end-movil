            ...
            <View>
              {
                this.state.songs.map((item, i) => (
                  <ListItem
                    ...
                    onPress={ () => {this.reproducirCancion(this.props.route.params, item.idCancion.l_id.c_id, item.idCancion.l_id.l_id, item.idCancion.l_id.u)}}//this.reproducirCancion(this.props.route.params)
                    bottomDivider
                  />
                ))
              }
