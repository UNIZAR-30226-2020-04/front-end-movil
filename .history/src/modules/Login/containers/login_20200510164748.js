...
export default class App extends Component{
  ...
  loginDB = async () => { //console.log("DEVULVE:",NetworkService.loginUser(this.state));
    if(this.state.email!="" && this.state.password!=""){
      ...
      //await NetworkService.fetchAlbums(this.state).then(res => {this.state.user.state.albums = albums});
...
//************************************************************************************************************************** */
  goToMain(){ 
    ...
    this.props.navigation.navigate('MainLogged', { screen: 'DashBoard'} ); //{ screen: 'DashBoard', params: {user: this.state.user} }
  }
//************************************************************************************************************************** */
