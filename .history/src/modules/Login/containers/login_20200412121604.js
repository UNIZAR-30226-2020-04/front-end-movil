...
export default class App extends Component{
  ...
  storeData = async () => {
    ...
    try {
      ...
      return console.log("Guardando this.user...")
    } catch (error) {
       return console.log("Fallo al guardar..")
      // Error saving data
    }
  };
  ...
  loginDB = () => { //console.log("DEVULVE:",NetworkService.loginUser(this.state));
    ...
    if(this.checkLoginOK){
      ...
      let result = this.storeData;//.then( data => {console.log("data:",data)} ).catch("Error storing")
      this.goToMain()
    } else {
