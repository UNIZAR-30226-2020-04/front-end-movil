...
export default class Profile extends Component{
  ...
  componentDidMount(){
    this.retrieveUser().then( res => {
      ...
      this.getAlbumsDB().then( res => {console.log("HA IDO", res)}).catch(err => console.log("Error",err));
      ...
      <ImageBackground source={require('../../../Wallpapers/fondo.jpg')} style={styles.container}>
        <ScrollView style={styles.screen}>
            ...
            <View style={{height: 200, marginTop: 20}}>
              <ScrollView horizontal={true}>
                ...
                {this.state.albums.map(
                  element => 
                    <Element type='album' paramId={element.idAlbum.l_id} image = {{ uri: element.foto==null ? DEFAULT_URI : element.foto }} album_name={element.nombre} artist={element.idAlbum.u} props={this.props}></Element>
                  )
                }
              </ScrollView>
            </View>
          ...
          <View style={styles.container}>
            ...
            <View style={{height: 200, marginTop: 20}}>
              <ScrollView horizontal={true}>
                <Element type='playlist' image={{uri: 'https://bucket3.glanacion.com/anexos/fotos/79/2667179h1080.jpg'}} name="Redención" artist="cualquiera"></Element>
              </ScrollView>
            </View>
          </View>
