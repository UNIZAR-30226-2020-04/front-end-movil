            ...
            <View style={{height: 200, marginTop: 20}}>
              <ScrollView horizontal={true}>
                ...
                {this.state.albums.map(
                  element => 
                    <Element type='album' paramId={element.idAlbum.l_id} image = {{ uri: element.foto==null ? DEFAULT_URI : element.foto }} album_name={element.nombre} artist={element.idAlbum}></Element>
                  )
                }
              </ScrollView>
            </View>
