...
export default class Profile extends Component{
  ...
  getAlbumsDB = async () => {
    try {
      ...
      await NetworkService.fetchAlbums(this.state.user).then(res => {this.setState({albums: res});console.log("GETALBUMS RES:", res);console.log("GETALBUMS ALBUMS:", this.state.albums)});
    } catch (error) {
