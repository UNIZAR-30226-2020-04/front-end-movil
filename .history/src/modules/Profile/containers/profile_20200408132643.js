        ...
        <ScrollView style={styles.screen}>
          ...
          <View style={{flexDirection : 'row', height: 200, marginTop: 10, marginLeft: 10, marginRight: 10}}>
            <View style={styles.info}>
              <View>
                <Text style={[styles.text, {fontSize: 20,fontWeight: '600'}]}>Email {"\n"}{this.state.user.email}</Text>
                <Text style={[styles.text, {fontSize: 20,fontWeight: '600'}]}>Username {"\n"}{this.state.user.username}</Text>
                <Text style={[styles.text, {fontSize: 20,fontWeight: '600'}]}>Info {"\n"}{this.state.user.info}</Text>
              </View>
            </View>
