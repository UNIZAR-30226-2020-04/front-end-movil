                  ...
                  <ScrollView horizontal={true}>
                    ...
                    {this.props.route.params.props.albums.map(
                      ...
                      <Menu >
                        ...
                        <MenuOptions>
                            <MenuOption value={element.nombre} text={"Delete"} onSelect={type => {NetworkService.deleteAlbum(this.state.user.correo,element.idAlbum.l_id); alert(`Deleted ${type}`)}} style={{color: 'white'}}/>
                        </MenuOptions>
                      </Menu>
                    </MenuProvider>
                      )
                      ...
                      element => 
                        <MenuProvider>
                          <Menu >
                            ...
                            <MenuOptions>
                                <MenuOption value={element.nombre} text={"Delete"} onSelect={type => {NetworkService.deletePlaylist(this.state.user.correo,element.idRep.l_id); alert(`Deleted ${type}`)}} style={{color: 'white'}}/>
                            </MenuOptions>
                          </Menu>
                        </MenuProvider>
                      )
