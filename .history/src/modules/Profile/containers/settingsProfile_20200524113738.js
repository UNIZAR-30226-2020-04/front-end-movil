                ...
                <Menu >
                  ...
                  <MenuOptions>
                    <ScrollView style={{ maxHeight: 200 }}>
                      <MenuOption value={"getAlbumName()"} text={"Delete"} onSelect={type => {NetworkService.deletePlaylist(this.state.user.correo,element.idPodcast.l_id.toString()); alert(`Deleted ${type}`)}} style={{color: 'white'}}/>
                    </ScrollView>
                  </MenuOptions>
                </Menu>     
            </MenuProvider>
