...
export default class Profile extends Component{
  ...
  getPlaylistDB = async () => {
    try {
      console.log("STATE.USER",this.state.user)
      await NetworkService.fetchPlaylists(this.state.user).then(res => {this.setState({albums: res, loadedPlaylists:true});console.log("GETALBUMS RES:", res);console.log("GETALBUMS ALBUMS:", this.state.albums)});
    } catch (error) {
      console.log("Error al obtener Albumes")
    }
  };
