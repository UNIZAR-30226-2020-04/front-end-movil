        ...
        <ScrollView style={styles.screen}>
          ...
          <View style={{height: 200, marginTop: 10, marginLeft: 10, marginRight: 10}}>
            <View style={styles.info}>
              <Text style={[styles.text, {fontSize: 20,fontWeight: '600', marginLeft: 5}]}>Your name</Text>
              <View style={styles.inputView} >
                <TextInput  
                  ...
                  onChangeText={text =>  this.state.user.newUsername=text}/>
              </View>
          ...
          <TouchableOpacity style={styles.deleteBtn} onPress={this.deleteUser}>
            ...
            <View style={styles.inputView} >
                <TextInput  
                  ...
                  placeholderTextColor="#FFFFFF"
                  onChangeText={text => this.setState(this.state.user.passwordCheck=text)}/>
              </View>
