            ...
            <View style={{height: 200, marginTop: 20}}>
              <ScrollView horizontal={true}>
                ...
                {this.state.albums.map(
                  element => 
                    <Element type='album' paramId={element.idAlbum.l_id} image = {{ uri: element.urlfoto==null ? DEFAULT_URI : BASE_URL+element.urlfoto }} name={element.nombre} artist={element.idAlbum.u} props={this.props}></Element>
                  )
                }
              </ScrollView>
            </View>
