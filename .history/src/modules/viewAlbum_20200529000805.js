...
export default class viewAlbum extends Component{
  ...
  peticionBorrar = (item) => {
    NetworkService.deleteCancionAlbum(item.idCancion.l_id.u, item.idCancion.l_id.l_id, item.idCancion.c_id).then(res => console.log("BORRADO??: ", res)).catch(err => console.log("Error ", err))
  }
