...
export default class viewPodcast extends Component{
  ...
  peticionBorrar = async (item) => {
    ...
    await NetworkService.deleteCapituloPodcast(item.idCapitulo.l_id.u, item.idCapitulo.l_id.l_id.toString() , item.idCapitulo.c_id).then(res => console.log("BORRADO PODCAST??: ", res)).catch(err => console.log("Error ", err))
  }
                    ...
                    rightIcon={
                      ...
                      onPress={ () => {Alert.alert(
                        ...
                        [
                          ...
                          {
                            text: 'Delete item',
                            onPress: () => this.peticionBorrar(item),
                            style: 'cancel'
                          },
                        ],
                        { cancelable: false }
