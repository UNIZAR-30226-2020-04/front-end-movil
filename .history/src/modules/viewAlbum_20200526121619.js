...
export default class viewAlbum extends Component{
  ...
  reproducirCancion(ruta,idCancion,idAlbum,correo){
    ...
    console.log("Playlist en viewALBUM-------------------------",this.PLAYLIST)
            ...
            <View>
              {
                this.state.songs.map((item, i) => (
                  <ListItem
                    ...
                    onPress={ () => {this.reproducirCancion(this.props.route.params, item.idCancion.l_id, this.props.route.params.paramId, item.idCancion.l_id.u)}}//this.reproducirCancion(this.props.route.params)
                    bottomDivider
                  />
                ))
              }
