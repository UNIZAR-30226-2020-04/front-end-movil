            ...
            <View>
              {
                this.state.songs.map((item, i) => (
                  <ListItem
                    ...
                    type='font-awesome'
                    color='#000'/>}//<Ionicons name="volume-high-outline" size={40} color="white" onPress={this.goToSettings} style={{position:'absolute', right: 10, bottom: 10}}></Ionicons>}
                    rightIcon={<Icon name='volume-up'
                    type='font-awesome'
                    color='#000'/>}
