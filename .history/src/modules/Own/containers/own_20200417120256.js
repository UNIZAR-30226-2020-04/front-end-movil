...
import { StyleSheet, Text, View, TouchableOpacity, Button, Image, File} from 'react-native';
...
export default class Own extends React.Component {
  ...
  _pickDocument = async () => {
      ...
      console.log("Result:", result)
      const bytes = await FileSystem.readAsStringAsync(result.uri)
      console.log("bytes:", bytes);
      File file = new File(bytes,result.name);
