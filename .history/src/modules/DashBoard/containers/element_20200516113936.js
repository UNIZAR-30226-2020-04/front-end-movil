        ...
        if(this.props.type==='album'){
            return(
                <View style={{ height:200, width:150, marginLeft: 20, 
                    ...
                    onStartShouldSetResponder={() => navigation.navigate('Library', this.props)}//<ViewAlbum props={this.props}></ViewAlbum>}//this.props.props.navigation.navigate("viewAlbum", this.props)}    
