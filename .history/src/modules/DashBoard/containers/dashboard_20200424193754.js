...
//Devulve el usuario del asyncstorage
async function retrieveData2(){
  let user_state = await Dashboard.retrieveData//.then( res => {user_state = res});
  return user_state
}
...
export default class Dashboard extends Component{
  ...
  componentDidMount(){
    ...
    let user_state = this.retrieveData;
    ...
    this.state.user.state = user_state;
