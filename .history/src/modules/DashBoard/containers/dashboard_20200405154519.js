...
import { StyleSheet, Text, View, TextInput, Button, Alert, ScrollView, Image, ImageBackground, TouchableOpacity, Icon, List } from 'react-native';
        ...
        <View>
          {
            list.map((l, i) => (
              <List
                horizontal = {true}
                key={i}
                leftAvatar={{ source: { uri: l.image_album_url } }}
                title={l.album_name}
                subtitle={l.song_name}
                bottomDivider
              />
            ))
          }
