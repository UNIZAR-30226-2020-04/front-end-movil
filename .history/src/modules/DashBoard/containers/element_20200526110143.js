        ...
        if(this.props.delete==='true'){
            ...
            if(this.props.type==='album'){
                return(
                    <View style={{ height:200, width:150, marginLeft: 20, 
                        borderBottomColor: 'transparent'}}
                        onStartShouldSetResponder={() => {console.log("this.props.props*******************", this.props);this.props.props.navigation.navigate('viewAlbum', this.props)}}//<ViewAlbum props={this.props}></ViewAlbum>}//this.props.props.navigation.navigate("viewAlbum", this.props)}    
                    >
                        <View style={{ flex: 5 }}>
                            <Image source={this.props.image} 
                                style={{flex:1,width:null, height: null,
