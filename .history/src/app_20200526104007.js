...
const OwnStack = createStackNavigator();
  ...
  function MusicPlayerStackScreen() {
    return (
      <MusicPlayerStack.Navigator screenOptions = {{
        headerTransparent: true,
        headerTintColor:'white',
        headerTitleStyle:{
          fontSize: 24,
        ...
        <MusicPlayerStack.Screen name="MusicPlayer" component={MusicPlayer} /> 
...
function menuLogged(){
  return (
    ...
    >
      ...
      <MenuLoged.Screen name="MusicPlayer" component={MusicPlayerStackScreen} />
